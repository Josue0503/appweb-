...
@error('title') is-invalid @enderror" placeholder="Title" value="{{ old('title') }}">
...
@error('category') is-invalid @enderror" placeholder="Category" value="{{ old('category')}}">
...
@error('content') is-invalid @enderror" placeholder="Proyect Content">{{ old('content')}}</textarea>
