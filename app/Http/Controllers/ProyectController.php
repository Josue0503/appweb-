...
$proyectData = ['title' => $request->title, 'category_id' => $request->category,
'content' => $request->content, 'image' => $imageName];
Proyect::create($proyectData);
return redirect('/proyects')->with(['message' => 'Proyect added successfully!',
'status' => 'success']);
}
/**
...
return redirect('/proyects')->with(['message' => 'Proyect updated successfully!',
'status' => 'success']);
}
/**
...
Storage::delete('public/images/' . $proyect->image);
$proyect->delete();
return redirect('/proyects')->with(['message' => 'Proyect deleted successfully!',
'status' => 'info']);
}
}
